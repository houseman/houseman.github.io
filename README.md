...
I joined Takealot in September 2020, as a **Senior Software Engineer I** in the Discovery Backend (DSCBE) team.
...
The infrastructure at Takealot runs almost exclusively in Kubernetes, and engineers are required to be proficient in managing and deploying to Kubernetes clusters (using Helm and Jenkins).
...
We are a Python shop, and our team's work is almost exclusively implemented through Python. We follow a set of Python engineering best practices such as:
- Mypy static type-checker
- Black code formatter
- Flake8 code style-enforcer
- Pre-commit hooks for various other linting automation (iSort, trim whitespace etc.)
- Full unit test coverage, as well as automated integration testing
...
- **Project Lead**;
  - own projects from start to end,
  - plan work into sprints,
  - liaise with stakeholders (product managers, vendors, other teams)
  - responsible for on-time project delivery
- Analyze business requirements, and **architect solutions** that fulfill these requirements (at scale)
- Act as a **mentor** to junior and intermediate team-members, mostly through code review
...
I was a **Senior Systems Engineer** at Internet Solutions (IS), an enterprise internet service provider of choice for many years, and was a division of Dimension Data.

Here I was lead developer on various internal PHP & Perl projects within the Broadband and VoIP Billing and Provisioning departments.
Various projects undertaken include:
- Integration of VoIP billing data for invoice generation into SAP via a JMS queue
- Voice Carrier Least Cost Routing; a LCR calculation application, which determines the lowest cost international call routes, and implements these preferred routes via routing policies delivered to the network edge
- NumberDB v2 developed using Symfony 2; used by engineers and support to allocate and manage VoIP numbers from within allocated number blocks assigned by ICASA. NumberDB also has a SOAP API that enabled integration with provisioning and support systems
- Automated ADSL router provisioning and configuration; a REST service that received requests from ADSL router firmware on initial start-up, and generates a customised routing and firewall configuration for the relevant client, which was then downloaded and installed to the router flash storage
...
These were innovative times, and another useful tool that we produced, was a PHP framework that could inspect a database structure, and create data classes and other scaffolding based on this. This was (to the best of my knowledge) in a time before any similar PHP frameworks existed, and this saved our team much time and repetitive work, enabling a more agile approach to our software development projects.

My duties at Junk Mail included:
